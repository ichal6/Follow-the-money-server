...
VALUES (default, TO_DATE('2022-05-02','YYYY-MM-DD'), 'buy car', 'EXPENSE', -2500.00, 2, 1, 4);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-04-21','YYYY-MM-DD'), 'buy another car', 'EXPENSE', -2500.00, 2, 1, 4);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-05-10','YYYY-MM-DD'), 'buy milk', 'EXPENSE', -25.00, 2, 3, 2);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-05-10','YYYY-MM-DD'), 'buy bicycle', 'EXPENSE', -1200.00, 1, 4, 3);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-05-01','YYYY-MM-DD'), 'salary', 'INCOME', 1200.00, 3, 1, 1);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-04-01','YYYY-MM-DD'), 'salary', 'INCOME', 1200.00, 3, 1, 1);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-04-07','YYYY-MM-DD'), 'Morgage october', 'EXPENSE', -1000.00, 1, 2, 5);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-05-07','YYYY-MM-DD'), 'Morgage september', 'EXPENSE', -1000.00, 1, 2, 5);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-06-07','YYYY-MM-DD'), 'Morgage january', 'EXPENSE', -1000.00, 1, 2, 5);

INSERT INTO "transaction" (id, date, title, type, value, category_id, payee_id, account_id)
VALUES (default, TO_DATE('2022-04-07','YYYY-MM-DD'), 'Morgage february', 'EXPENSE', -1000.00, 1, 2, 5);

INSERT INTO "transfer" (id, date, title, value, account_from_id, account_to_id)
VALUES (default, TO_DATE('2022-04-02','YYYY-MM-DD'), 'wplatomat wrzesien', 280.0, 2, 1);

INSERT INTO "transfer" (id, date, title, value, account_from_id, account_to_id)
VALUES (default, TO_DATE('2022-05-02','YYYY-MM-DD'), 'wplatomat pazdziernik', 200.0, 2, 1);

INSERT INTO "transfer" (id, date, title, value, account_from_id, account_to_id)
VALUES (default, TO_DATE('2022-05-12','YYYY-MM-DD'), 'wyplata z bankomatu', 200.0, 1, 2);

INSERT INTO "transfer" (id, date, title, value, account_from_id, account_to_id)
VALUES (default, TO_DATE('2022-05-12','YYYY-MM-DD'), 'wyplata z bankomatu', 400.0, 1, 2);
